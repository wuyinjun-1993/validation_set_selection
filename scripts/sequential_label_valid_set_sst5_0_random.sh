...
add_valid_in_training_flag="--cluster_method_three --cosin_dist --weight_by_norm --replace --use_model_prov --model_prov_period 1 --total_valid_sample_count ${total_valid_sample_count}"
