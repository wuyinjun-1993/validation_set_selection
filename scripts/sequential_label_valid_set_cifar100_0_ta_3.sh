...
exe_cmd="python -m torch.distributed.launch \
  ...
  --flip_labels \
  --err_label_ratio ${err_label_ratio} \
  --save_path ${save_path_prefix}_ta_seq_select_0_3/ \
...
output_file_name=${output_dir}/output_${dataset_name}_rand_error_${err_label_ratio}_ta_select_seq_select_0_3.txt
...
do
    ...
    --flip_labels \
    --err_label_ratio ${err_label_ratio} \
    --save_path ${save_path_prefix}_ta_seq_select_${k}_3/ \
    --prev_save_path ${save_path_prefix}_ta_seq_select_$(( k - 1 ))_3/ \
    --cuda \
    --lr ${lr} \
    --batch_size ${batch_size} \
    --test_batch_size ${test_batch_size} \
	...
	output_file_name=${output_dir}/output_${dataset_name}_rand_error_${err_label_ratio}_ta_select_seq_select_${k}_3.txt
