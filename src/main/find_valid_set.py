...
#     dis = compute_distance_both(args, True, True, sample_representation_vec_ls, valid_sample_representation_tensor, args.cuda)
...
#         extra_valid_ids, extra_valid_sample_representation_tensor = cluster_per_class_both(args, subset_outlier, subset_outlier_sample_ids, valid_count_per_class = extra_cluster_count, num_clusters = extra_cluster_count, sample_weights=sub_sample_weights, cosin_distance=True, is_cuda=args.cuda, all_layer=True)  
...
#         full_extra_dis = compute_distance_both(args, True, True, sample_representation_vec_ls, full_extra_valid_sample_representation_tensor_ls, args.cuda)
...
#     far_sample_representation_tensor = full_sample_representation_tensor
#     full_dists = compute_distance_both(args, True, True, full_sample_representation_tensor, valid_sample_representation_tensor, args.cuda)
#     cluster_max_radius = torch.max(torch.min(full_dists, dim = 1)[0])/3*2
    
#     while len(valid_ids) < main_represent_count - 1:
#         far_sample_representation_tensor, far_sample_ids = obtain_farthest_training_samples_both(args, True, True, far_sample_representation_tensor, valid_sample_representation_tensor, args.cuda)
#         all_sample_ids = all_sample_ids[far_sample_ids]

#         curr_representation_count = valid_count - len(valid_ids)
#         if cached_sample_weights is not None:
#             new_valid_ids, new_valid_sample_representation_tensor = cluster_per_class_both(args, far_sample_representation_tensor, all_sample_ids, valid_count_per_class = curr_representation_count, num_clusters = curr_representation_count, sample_weights=cached_sample_weights[far_sample_ids], cosin_distance=True, is_cuda=args.cuda, all_layer=True, return_cluster_info = return_cluster_info)  
#         else:
