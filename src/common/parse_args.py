...
def parse_args(args=None):
    ...
    parser.add_argument('--k_means_lr', default=0.00001, type=float, help='capture model_prov')
    parser.add_argument('--k_means_bz', default=128, type=int, help='capture model_prov')
    parser.add_argument('--k_means_epochs', default=50, type=int, help='capture model_prov')
